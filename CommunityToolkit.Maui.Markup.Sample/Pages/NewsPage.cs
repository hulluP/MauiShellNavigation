                    ...
                    NewsViewModel newsViewModel) : base(newsViewModel, "Top Stories")
    {
        ...
        Content = new RefreshView
        {
            Content = new CollectionView
            {
             ...
             .Bind(CollectionView.SelectionChangedCommandProperty, nameof(NewsViewModel.SelectedItem))
             .Bind(CollectionView.SelectedItemProperty, nameof(NewsViewModel.SelectedItem))
